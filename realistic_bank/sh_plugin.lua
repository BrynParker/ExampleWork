...
function PLUGIN:InitializedPlugins()
	ix.item.RegisterInv("SafetyBox10x5", 10,5)
	ix.item.RegisterInv("SafetyBox10x10", 10,10)
...
if (SERVER) then
	...
	function PLUGIN:DatabaseConnected()
		if bInit then 
			print("[MYSQL] Database already initialized. Skipping table creation.")
			return 
		end
		
		print("[MYSQL] Creating ix_bankaccounts table...")
	
		local query = mysql:Create("ix_bankaccounts")
		query:Create("id", "INT(11) UNSIGNED NOT NULL AUTO_INCREMENT")
		query:Create("account_id", "BIGINT(20) UNSIGNED NOT NULL DEFAULT '0'")
		query:Create("owner", "INT(10) UNSIGNED NOT NULL DEFAULT '0'")
		query:Create("owner_name", "VARCHAR(50) NOT NULL DEFAULT ''")
		query:Create("group_acc_name", "VARCHAR(50) NOT NULL DEFAULT ''")
		query:Create("money", "FLOAT(15, 2) UNSIGNED NOT NULL DEFAULT '0.00'")
		query:Create("is_groupaccount", "TINYINT(1) UNSIGNED NOT NULL DEFAULT '0'")
		query:Create("is_interest", "TINYINT(1) UNSIGNED NOT NULL DEFAULT '0'")
		query:Create("has_loan", "TINYINT(1) UNSIGNED NOT NULL DEFAULT '0'")
		query:Create("loan", "FLOAT(15, 2) UNSIGNED NOT NULL DEFAULT '0.00'")
		query:Create("loantime", "BIGINT(20) UNSIGNED NOT NULL DEFAULT '0'")
		...
		print("[MYSQL] ix_bankaccounts table creation query executed.")
