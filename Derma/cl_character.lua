local PANEL = {}
	...
	local materialtest = Material ("sci_char/bg_2.png")
	local charbox = Material ("sci_char/menu/merged.png")
	local buttonmat = Material ("sci_char/description_body.png")
	local outline = Material ("sci_char/border/bottom_border_effect.png")
	local outlinetop = Material ("sci_char/border/top_border_effect.png")
	local mainbg = Material ("bgs/ui_mainmenu_background2.png")
	...
	function PANEL:Init()
		...
		local function AddMenuLabel(text, callback, isLast, noTranslation, parent)
			...
			return label
						...
						vgui.Register("MainBG2", PANEL, "DModelPanel")
						
						self.MainBG = self:Add("MainBG2")
						self.MainBG:SetPos(0, 0)
						self.MainBG:SetSize(ScrW() * 1, ScrH() *1)
						self.MainBG:SetAlpha(255)
						self.MainBG:SetZPos(-1)
						self.MainBG.Paint = function(this, w, h)
						...
						vgui.Register("BannerT", PANEL, "DModelPanel")
						
						self.Banner = self:Add("BannerT")
						self.Banner:SetPos(0, 1000)
						self.Banner:SetSize(1000, 30)
						self.Banner:SetAlpha(255)
						self.Banner:Dock(BOTTOM)
						self.Banner:SetZPos(1000)
						...
						vgui.Register("BannerT2", PANEL, "DModelPanel")
						
						self.Banner2 = self:Add("BannerT2")
						self.Banner2:SetPos(0, 1000)
						self.Banner2:SetSize(1000, 30)
						self.Banner2:SetAlpha(255)
						self.Banner2:Dock(TOP)
						self.Banner2:SetZPos(1000)
						self.Banner2.Paint = function(this, w, h)
							...
							surface.SetDrawColor(color.r, color.g, color.b, 255)
							surface.SetMaterial(outlinetop)
							surface.DrawTexturedRect(0, 0, w, h)
						...
						vgui.Register("TestPanel2", PANEL, "DModelPanel")
						
						self.CharBox = self:Add("TestPanel2")
						self.CharBox:SetPos(ScrW() * 0.1, ScrH() * 0.29)
						self.CharBox:SetSize(300, 260)
						self.CharBox:SetAlpha(255)
						self.CharBox:SetZPos(-1)
						self.CharBox.Paint = function(this, w, h)
			...
			if (count > 0 and #nut.characters < maxChars and hook.Run("ShouldMenuButtonShow", "create") != false) then
				AddMenuLabel("create", function()
					ClearAllButtons(function()
						...
						vgui.Register("CreateMainBG2", PANEL, "DModelPanel")
						
						self.MainBGCreate = self:Add("CreateMainBG2")
						self.MainBGCreate:SetPos(0, 0)
						self.MainBGCreate:SetSize(ScrW() * 1, ScrH() *1)
						self.MainBGCreate:SetAlpha(255)
						self.MainBGCreate:SetZPos(-1)
						self.fadePanels[#self.fadePanels + 1] = self.MainBGCreate
						self.MainBGCreate.Paint = function(this, w, h)
							...
							surface.SetMaterial(materialtest)
							surface.SetDrawColor(255, 255, 255, 255)
							surface.DrawTexturedRect(0, 0, w, h)
			...
			if (#nut.characters > 0 and hook.Run("ShouldMenuButtonShow", "load") != false) then
				AddMenuLabel("load", function()
					ClearAllButtons(function()
						...
						self.charList:SetPos(ScrW() * 0.766, ScrH() * 0.22)
						...
						vgui.Register("TestPanel", PANEL, "DModelPanel")
						
						self.Test = self:Add("TestPanel")
						self.Test:SetPos(0, 0)
						self.Test:SetSize(ScrW() * 1, ScrH() *1)
						self.Test:SetAlpha(255)
						self.Test:SetZPos(-1)
						self.fadePanels[#self.fadePanels + 1] = self.Test
						self.Test.Paint = function(this, w, h)
						...
						self.CharBox = self:Add("TestPanel2")
						self.CharBox:SetPos(ScrW() * 0.75, ScrH() * 0.15)
						self.CharBox:SetSize(350, 600)
						self.CharBox:SetAlpha(255)
						self.CharBox:SetZPos(-1)
						self.fadePanels[#self.fadePanels + 1] = self.CharBox
						self.CharBox.Paint = function(this, w, h)
						...
						self.model:SetPos(ScrW() * 0.3899, ScrH() * 0.1)
						self.model:MoveBelow(self.subTitle, 64)
						self.model:SetSize(ScrW() * 0.22, ScrH() * 0.457)
						self.model:SetModel("models/error.mdl")
						self.model:SetFOV(58)
						...
						self.choose:SetPos(self.model:GetWide() * 0.000, self.model:GetTall() * 0.85)
						...
						self.delete:SetPos(self.model:GetWide() * 0.59, self.model:GetTall() * 0.85)
