...
FACTION.name = "Metro-Dade Bureau of Special Operations"
FACTION.description = "It's in the name..."
FACTION.color = Color(20, 120, 185)
FACTION.pay = 10 -- How much money every member of the faction gets paid at regular intervals.
FACTION.weapons = {
"weapon_pistol", "weapon_rpt_handcuff", "weapon_rpt_finebook", "weapon_rpt_stungun", "dradio", "weapon_polearm"
}
