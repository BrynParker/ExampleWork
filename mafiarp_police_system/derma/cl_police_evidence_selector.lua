...
function PANEL:Init()
	...
	local WindowTitle = self:Add( "DLabel")
	WindowTitle:SetPos(2,2)
	WindowTitle:SetWide(self:GetWide())
	WindowTitle:SetFont("xpgui_gigantic")
	...
	local CustomImage_Text = CustomImage:Add( "DLabel")
...
function PANEL:ShowInvItems(items)
	...
	for k, v in pairs(items) do
		...
		local ItemTitle = ItemPanel:Add( "DLabel")
		ItemTitle:Dock(BOTTOM)
		ItemTitle:DockMargin(0,0,0,10)
		ItemTitle:SetFont("xpgui_gigantic")
