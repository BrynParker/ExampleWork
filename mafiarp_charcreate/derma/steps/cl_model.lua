...
function PANEL:Init()
    ...
    self.scroll:DockMargin(0, ScreenScale(25), 0, 0)
    
    -- Create the icon layout and add it to the scroll panel
    self.models = self.scroll:Add("DIconLayout")
